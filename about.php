...
$ketua = $ctrl_struktur->getJabatanStruktur('ketua');
$sekretaris = $ctrl_struktur->getJabatanStruktur('sekretaris');
$bendahara = $ctrl_struktur->getJabatanStruktur('bendahara');
$anggota = $ctrl_struktur->getJabatanStruktur('anggota');
include 'layout/header.php';
 ?>

        <div class="img-title pt-5">
          <div class="h2 white mt-100 text-center">Tentang Kami</div>
        </div>
        <div class="main">
